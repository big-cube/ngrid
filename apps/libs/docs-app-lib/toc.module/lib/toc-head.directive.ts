 ...
 *
 * Other elements can also be used as link headers, to mark them add the `pblTocHead` attribute to
...
export class TocHeadDirective implements AfterViewInit, OnDestroy {
   ...
   * To use height H elements add the `pblTocHead` attribute (level will be taken from tag name)
   */
